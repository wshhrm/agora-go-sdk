...
/*
#cgo CFLAGS: -Iagora_sdk/include_c/api2 -Iagora_sdk/include_c/base
#cgo darwin LDFLAGS: -Wl,-rpath,agora_sdk_mac -Lagora_sdk_mac -luap_aed
#cgo linux LDFLAGS: -Lagora_sdk/ -lagora_uap_aed
#include <string.h>
#include "vad.h"
*/
import "C"
