...
// #cgo darwin LDFLAGS: -Wl,-rpath,agora_sdk_mac -Lagora_sdk_mac -lAgoraRtcKit -lAgorafdkaac -lAgoraffmpeg
// #cgo linux LDFLAGS: -Lagora_sdk/ -lagora_rtc_sdk -lagora-fdkaac -lagora-core
